...
```javascript
import fromWordf from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-from-word@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/number-float32-base-from-word/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/number-float32-base-from-word/actions/workflows/test.yml?query=branch:v0.2.3
