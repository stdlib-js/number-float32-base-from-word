...
```javascript
fromWordf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-from-word@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-from-word@v0.1.0-umd/browser.js"></script>
```
